...
#if ! defined RAM_500X8_CC
#define RAM_500X8_CC 1
...
#include "RAM_500X8.h"
...
#ifdef STRATUS_HLS
   sc_uint<8> RAM_500X8::read0(sc_uint<9> A0, bool WE0) {
      sc_uint<8> DOUT0;
...
#endif	// STRATUS_HLS
#ifdef STRATUS_HLS
   sc_uint<8> RAM_500X8::write0(sc_uint<9> A0, sc_uint<8> DIN0, bool WE0) {
...
#endif	// STRATUS_HLS
#ifdef STRATUS_HLS
   void RAM_500X8::nop0(bool WE0) {
      CYN_BIND(WE0,this->WE0);
      HLS_CONFIG_INSTRUCTION( "access_port", 1 );
   }

#endif	// STRATUS_HLS
   void RAM_500X8::thread0() {
   ...
   RAM_500X8::RAM_500X8(const sc_module_name name)
      : sc_module( name ) ,CLK("CLK"),WE0("WE0"),DIN0("DIN0"),DOUT0("DOUT0"),A0("A0"), mem()
#else
   RAM_500X8::RAM_500X8( sc_module_name name)
      : sc_module( name ) ,CLK("CLK"),WE0("WE0"),DIN0("DIN0"),DOUT0("DOUT0"),A0("A0"), mem() 
#if defined(__GNUC__) 
		, m_iface(0)
#endif
#endif
   {
    ...
    m_p1_tx_stream = new cynw_scv_memory_tx_stream< sc_uint<9>, sc_uint<8> >( (std::string("sc_main.") + std::string(this->name())).c_str(), esc_get_scv_tr_db() );
#endif
 
   }

const unsigned long RAM_500X8::implemented = 1;
const unsigned long RAM_500X8::pipelined = 1;
const float RAM_500X8::area = 1000;
const float RAM_500X8::delay = 0;
const float RAM_500X8::setup_time = 0;
const unsigned long RAM_500X8::latency_WE0 = 1;
const unsigned long RAM_500X8::latency_DIN0 = 1;
const unsigned long RAM_500X8::latency_A0 = 1;
const unsigned long RAM_500X8::bits_per_maskbit_WM0 = 0;
const unsigned long RAM_500X8::reg_mem_inputs = 0;
const unsigned long RAM_500X8::reg_mem_outputs = 0;
const unsigned long RAM_500X8::regs_at_mem_inputs = 0;
const unsigned long RAM_500X8::regs_at_mem_outputs = 0;
const unsigned long RAM_500X8::no_spec_reads = 1;
const unsigned long RAM_500X8::is_mem = 1;
const unsigned long RAM_500X8::clock_multiplier = 0;
const bool RAM_500X8::has_extra_ports = false;
const bool RAM_500X8::is_prototype = false;
const char* RAM_500X8::naming_convention = 0;
