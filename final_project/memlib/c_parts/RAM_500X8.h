...
struct RAM_500X8
  : public sc_module,
    public cynw_memory_if< sc_uint<9>, sc_uint<8> >
#endif
    {
	HLS_EXTERNAL_MODULE;
...
#if defined(__GNUC__) 
    cynw_memory_if< sc_uint<9>, sc_uint<8> >* m_iface;

    void set_iface( cynw_memory_if< sc_uint<9>, sc_uint<8> >* iface ) {
        m_iface = iface;
    }
...
#endif
#ifdef STRATUS_HLS
   sc_uint<8> read0(sc_uint<9> A0, bool WE0=1);

#endif	// STRATUS_HLS
#ifdef STRATUS_HLS
   sc_uint<8> write0(sc_uint<9> A0, sc_uint<8> DIN0, bool WE0=0);
...
#else
   SC_HAS_PROCESS( RAM_500X8 );

   RAM_500X8( sc_module_name name = sc_module_name(sc_gen_unique_name("RAM_500X8")));
#endif
   ...
   typedef sc_uint<9>                       address_type;
   ...
   void put( const address_type& address, const data_type& data )
   {
    ...
    cynw_scv_memory_tx_stream< sc_uint<9>, sc_uint<8> >* m_p1_tx_stream;
    cynw_scv_memory_tx< sc_uint<9>, sc_uint<8> > m_p1_tx_0;
#endif
...
// 
struct RAM_500X8_ext_signals_1
{
    RAM_500X8_ext_signals_1( const char* prefix=0 ) 
   ...
   HLS_SC_SIGNAL_DECL( sc_uint<9>, true ) A0;
...
struct RAM_500X8::types
{  
    typedef sc_uint<9>                       address_type;
    typedef sc_uint<8>                      data_type;
    typedef sc_int<8>                       signed_type;
    typedef RAM_500X8                             mem_type;
    typedef cynw_memory_if< address_type, data_type >    if_type;
    typedef RAM_500X8::wrapper<HLS_L>                  wrapper;

    typedef RAM_500X8::port<HLS_L,data_type>              port;
    typedef RAM_500X8::ex_port<HLS_L>                     ex_port;
    typedef RAM_500X8::reg_ex_port<HLS_L>                 reg_ex_port;
    typedef RAM_500X8::reg_port<HLS_L,data_type>          reg_port;
    typedef RAM_500X8::stall_port<HLS_L,data_type>        stall_port;
    typedef RAM_500X8::shared_2<HLS_L>                 shared_2;
    typedef RAM_500X8::shared_3<HLS_L>                 shared_3;
    typedef RAM_500X8::shared_4<HLS_L>                 shared_4;
    typedef RAM_500X8_ext_signals_1             ext_signals_1;
...
//
template <typename HLS_L>
class RAM_500X8::wrapper :
    public sc_module,
    public RAM_500X8_ext_signals_1,
    public RAM_500X8::types<HLS_L>
{
  public:
    typedef RAM_500X8::wrapper<HLS_L>                 this_type;
  public:
    SC_HAS_PROCESS(wrapper);
    wrapper( sc_module_name in_name=sc_module_name( sc_gen_unique_name("RAM_500X8")) )
      : sc_module(in_name)
      , model(basename())  
	  ,CLK("CLK")
...
template <typename HLS_L>
class RAM_500X8::shared_2 :
    public sc_module,
    public RAM_500X8::types<HLS_L>
{   
  public:
    typedef RAM_500X8::shared_2<HLS_L>               this_type;
   typedef sc_uint<9>                       address_type;
   typedef sc_uint<8>                      data_type;
  public:
    SC_HAS_PROCESS(shared_2);
    shared_2( sc_module_name in_name=sc_module_name( sc_gen_unique_name("RAM_500X8")) )
      : sc_module(in_name)
      , model(basename())
	  ,CLK("CLK")
      ,if1("if1"),if2("if2")
  ...
  public:
    ...
    // Interface signals.
    //
    RAM_500X8_ext_signals_1    if1;
    RAM_500X8_ext_signals_1    if2;
  ...
  public:
    ...
    RAM_500X8_ext_signals_1    intsigs;
...
template <typename HLS_L>
class RAM_500X8::shared_3 :
    public sc_module,
    public RAM_500X8::types<HLS_L>
{   
  public:
    typedef RAM_500X8::shared_3<HLS_L>               this_type;
   typedef sc_uint<9>                       address_type;
   typedef sc_uint<8>                      data_type;
  public:
    SC_HAS_PROCESS(shared_3);
    shared_3( sc_module_name in_name=sc_module_name( sc_gen_unique_name("RAM_500X8")) )
      : sc_module(in_name)
      , model(basename())
	  ,CLK("CLK")
...
template <typename HLS_L>
class RAM_500X8::shared_4 :
    public sc_module,
    public RAM_500X8::types<HLS_L>
{   
  public:
    typedef RAM_500X8::shared_4<HLS_L>               this_type;
   typedef sc_uint<9>                       address_type;
   typedef sc_uint<8>                      data_type;
  public:
    SC_HAS_PROCESS(shared_4);
    shared_4( sc_module_name in_name=sc_module_name( sc_gen_unique_name("RAM_500X8")) )
      : sc_module(in_name)
      , model(basename())
	  ,CLK("CLK")
...
class RAM_500X8::port
  : public RAM_500X8::types<HLS_L>
  , public cynw_clk_rst_facade
{
  public:
    HLS_METAPORT;
    typedef RAM_500X8::port<HLS_L,HLS_ACCESS,HLS_MAPPING>            this_type;
...
//
template <typename HLS_L>
class RAM_500X8::ex_port
  : public RAM_500X8::types<HLS_L>
{
  public:
    HLS_METAPORT;
    typedef RAM_500X8::ex_port<HLS_L>            this_type;
   typedef sc_uint<9>                       address_type;
   typedef sc_uint<8>                      data_type;
  ...
  public:
   ...
   sc_export< sc_signal_out_if< sc_uint<9> > > A0;
...
//
template <typename HLS_L>
class RAM_500X8::reg_ex_port
  : public RAM_500X8::ex_port<HLS_L>,
	public sc_module,
	public cynw_clk_rst

{
  public:
    typedef RAM_500X8::reg_ex_port<HLS_L>            this_type;
    typedef RAM_500X8::ex_port<HLS_L>            base_type;
   typedef sc_uint<9>                       address_type;
   typedef sc_uint<8>                      data_type;
  ...
  public:
        ...
        sc_signal< sc_uint<9> > A0_reg;
        sc_signal< bool > REQ0_reg;
        sc_out< bool > WE0_p;
        sc_out< sc_uint<8> > DIN0_p;
        sc_out< sc_uint<9> > A0_p;
        sc_out< bool > REQ0_p;
...
//
template <typename HLS_L,typename HLS_ACCESS,HLS::HLS_INDEX_MAPPING_OPTIONS HLS_MAPPING>
class RAM_500X8::stall_port
  : public RAM_500X8::port<HLS_L,HLS_ACCESS,HLS_MAPPING>,
    public sc_module,
    public cynw_clk_rst
{
  public:
    typedef RAM_500X8::stall_port<HLS_L,HLS_ACCESS,HLS_MAPPING>       this_type;
    typedef RAM_500X8::port<HLS_L,HLS_ACCESS,HLS_MAPPING>       base_type;
    typedef cynw_memory_ref< this_type, HLS_ACCESS, HLS_MAPPING > ref_type;
    typedef sc_uint<9>                       address_type;
    typedef sc_uint<8>                      data_type;
    typedef unsigned int                          mask_type;
...
//
template <typename HLS_L,typename HLS_ACCESS,HLS::HLS_INDEX_MAPPING_OPTIONS HLS_MAPPING>
class RAM_500X8::reg_port
  : public RAM_500X8::port<HLS_L,HLS_ACCESS,HLS_MAPPING>,
    public sc_module,
    public cynw_clk_rst
{
  public:
    typedef RAM_500X8::reg_port<HLS_L,HLS_ACCESS,HLS_MAPPING>       this_type;
    typedef RAM_500X8::port<HLS_L,HLS_ACCESS,HLS_MAPPING>       base_type;
    typedef cynw_memory_ref< this_type, HLS_ACCESS, HLS_MAPPING > ref_type;
    typedef sc_uint<9>                       address_type;
    typedef sc_uint<8>                      data_type;
  ...
  public:
    ...
    RAM_500X8_ext_signals_1    if_inner;
...
#if !defined(STRATUS_VLG)
template <typename HLS_L,typename HLS_ACCESS,HLS::HLS_INDEX_MAPPING_OPTIONS HLS_MAPPING>
class RAM_500X8::port<HLS_L,HLS_ACCESS,HLS_MAPPING>::shared_2 :
    public sc_module,
	public cynw_clk_rst_facade
{   
  public:
    typedef RAM_500X8::port<HLS_L,HLS_ACCESS,HLS_MAPPING>           port_type;
  ...
  public:
    ...
    void mux_inputs()
    {
       ...
       if ( (m_options & (HLS::HLS_USING_REG_PORT | HLS::HLS_USING_REG_EX_PORT)) == 0 ) {
            HLS_SET_OUTPUT_DELAY( m_port.WE0, 0 );
            HLS_SET_OUTPUT_DELAY( m_port.DIN0, 0 );
            HLS_SET_OUTPUT_DELAY( m_port.A0, 0 );
            HLS_SET_OUTPUT_DELAY( m_port.REQ0, 0 );
       }
        if (if1.REQ0) {
            m_port.WE0 = if1.WE0;
...
#if !defined(STRATUS_VLG)
template <typename HLS_L,typename HLS_ACCESS,HLS::HLS_INDEX_MAPPING_OPTIONS HLS_MAPPING>
class RAM_500X8::port<HLS_L,HLS_ACCESS,HLS_MAPPING>::shared_3 :
    public sc_module,
	public cynw_clk_rst_facade
{   
  public:
...
#if !defined(STRATUS_VLG)
template <typename HLS_L,typename HLS_ACCESS,HLS::HLS_INDEX_MAPPING_OPTIONS HLS_MAPPING>
class RAM_500X8::port<HLS_L,HLS_ACCESS,HLS_MAPPING>::shared_4 :
    public sc_module,
	public cynw_clk_rst_facade
{   
  public:
...
//
class RAM_500X8_untimed_model
  : public sc_module,
    public cynw_memory_if< sc_uint<9>, sc_uint<8> >
{
  public:
    typedef RAM_500X8_untimed_model            this_type;
    typedef sc_uint<9>              address_type;
    typedef sc_uint<8>               data_type;
  public:
    SC_CTOR(RAM_500X8_untimed_model)
    {

        esc_enable_scv_logging();
        m_tx_stream = new cynw_scv_memory_tx_stream< sc_uint<9>, sc_uint<8> >( (std::string("sc_main.") + std::string(this->name())).c_str(), esc_get_scv_tr_db() );
    }

    data_type get( const address_type& address )
    {
#if defined(__GNUC__)
      if((int)(address) >=  500) return 0;
#endif
    ...
    cynw_scv_memory_tx_stream< sc_uint<9>, sc_uint<8> >* m_tx_stream;
...
class RAM_500X8::port<CYN::TLM,HLS_ACCESS,HLS_MAPPING>
  : public RAM_500X8::types<CYN::TLM>,
    public cynw_clk_rst_facade,
    public sc_port< cynw_memory_if< sc_uint<9>, sc_uint<8> > >
{
  public:
    HLS_METAPORT;

    typedef RAM_500X8::port< CYN::TLM, HLS_ACCESS,HLS_MAPPING>   this_type;
    typedef cynw_memory_ref< this_type, HLS_ACCESS,HLS_MAPPING > ref_type;
    typedef RAM_500X8::types<CYN::TLM>     types;
    typedef sc_port< cynw_memory_if< sc_uint<9>, sc_uint<8> > > base_type;
    typedef sc_uint<9>                       address_type;
    typedef sc_uint<8>                      data_type;
    typedef unsigned int                          mask_type;
    class shared_2;
  ...
  public:
	...
	sc_event_finder& value_changed()
	{
        return *(new sc_event_finder_t<cynw_memory_if< sc_uint<9>, sc_uint<8> > >(*this));
	}
...
//
template <>
class RAM_500X8::ex_port<CYN::TLM>
  : public RAM_500X8::types<CYN::TLM>,
    public sc_export< cynw_memory_if< sc_uint<9>, sc_uint<8> > >
{
  public:
    typedef RAM_500X8::ex_port< CYN::TLM>   this_type;
    typedef RAM_500X8::types<CYN::TLM>     types;
    typedef sc_export< cynw_memory_if< sc_uint<9>, sc_uint<8> > > base_type;
   typedef sc_uint<9>                       address_type;
   typedef sc_uint<8>                      data_type;
...
//
template <>
class RAM_500X8::reg_ex_port<CYN::TLM>
  : public RAM_500X8::types<CYN::TLM>,
    public sc_export< cynw_memory_if< sc_uint<9>, sc_uint<8> > >,
	public cynw_clk_rst_facade
{
  public:
    typedef RAM_500X8::reg_ex_port< CYN::TLM>   this_type;
    typedef RAM_500X8::types<CYN::TLM>     types;
    typedef sc_export< cynw_memory_if< sc_uint<9>, sc_uint<8> > > base_type;
   typedef sc_uint<9>                       address_type;
   typedef sc_uint<8>                      data_type;
...
//
template <typename HLS_ACCESS,HLS::HLS_INDEX_MAPPING_OPTIONS HLS_MAPPING>
class RAM_500X8::stall_port<CYN::TLM,HLS_ACCESS,HLS_MAPPING>
  : public RAM_500X8::port<CYN::TLM,HLS_ACCESS,HLS_MAPPING>
{   
  public:
    typedef RAM_500X8::port<CYN::TLM,HLS_ACCESS,HLS_MAPPING>  base_type;
...
//
template <typename HLS_ACCESS,HLS::HLS_INDEX_MAPPING_OPTIONS HLS_MAPPING>
class RAM_500X8::reg_port<CYN::TLM,HLS_ACCESS,HLS_MAPPING>
  : public RAM_500X8::port<CYN::TLM,HLS_ACCESS,HLS_MAPPING>
{   
  public:
    typedef RAM_500X8::port<CYN::TLM,HLS_ACCESS,HLS_MAPPING>  base_type;
    typedef RAM_500X8::reg_port<CYN::TLM,HLS_ACCESS,HLS_MAPPING>  this_type;
...
#if !defined(STRATUS_VLG)
template <typename HLS_ACCESS,HLS::HLS_INDEX_MAPPING_OPTIONS HLS_MAPPING>
class RAM_500X8::port<CYN::TLM,HLS_ACCESS,HLS_MAPPING>::shared_2 :
    public sc_module,
	public cynw_clk_rst_facade,
    public cynw_memory_if< sc_uint<9>, sc_uint<8> >
{
  public:
    typedef RAM_500X8::port<CYN::TLM,HLS_ACCESS,HLS_MAPPING>           port_type;

    typedef typename port_type::shared_2                  this_type;
   typedef sc_uint<9>                  address_type;
   typedef sc_uint<8>                data_type;
    typedef cynw_memory_if< sc_uint<9>, sc_uint<8> >  if_type;
  public:
...
#if !defined(STRATUS_VLG)
template <typename HLS_ACCESS,HLS::HLS_INDEX_MAPPING_OPTIONS HLS_MAPPING>
class RAM_500X8::port<CYN::TLM,HLS_ACCESS,HLS_MAPPING>::shared_3 :
    public sc_module,
	public cynw_clk_rst_facade,
    public cynw_memory_if< sc_uint<9>, sc_uint<8> >
{
...
#if !defined(STRATUS_VLG)
template <typename HLS_ACCESS,HLS::HLS_INDEX_MAPPING_OPTIONS HLS_MAPPING>
class RAM_500X8::port<CYN::TLM,HLS_ACCESS,HLS_MAPPING>::shared_4 :
    public sc_module,
	public cynw_clk_rst_facade,
    public cynw_memory_if< sc_uint<9>, sc_uint<8> >
{
...
// 
template <>
class RAM_500X8::wrapper<CYN::TLM> :
    public sc_module,
    public RAM_500X8::types<CYN::TLM>,
    public cynw_memory_if< sc_uint<9>, sc_uint<8> >
{
  public:
    typedef RAM_500X8::wrapper<CYN::TLM>				this_type;
    typedef sc_uint<9>						    address_type;
    typedef sc_uint<8>						    data_type;
    typedef cynw_memory_if< address_type, data_type >   if_type;
  public:
  ...
  public:
    ...
    // The memory model.
    //
    RAM_500X8_untimed_model model;
};


#if !defined(STRATUS_VLG)
template <>
class RAM_500X8::shared_2<CYN::TLM> :
    public sc_module,
    public RAM_500X8::types<CYN::TLM>,
    public cynw_memory_if< sc_uint<9>, sc_uint<8> >
{
  public:
    typedef RAM_500X8::shared_2<CYN::TLM>           this_type;
    typedef sc_uint<9>                  address_type;
    typedef sc_uint<8>                   data_type;
    typedef cynw_memory_if< sc_uint<9>, sc_uint<8> >  if_type;
  public:
...
#if !defined(STRATUS_VLG)
template <>
class RAM_500X8::shared_3<CYN::TLM> :
    public sc_module,
    public RAM_500X8::types<CYN::TLM>,
    public cynw_memory_if< sc_uint<9>, sc_uint<8> >
{
  public:
    typedef RAM_500X8::shared_3<CYN::TLM>           this_type;
    typedef sc_uint<9>                  address_type;
    typedef sc_uint<8>                   data_type;
    typedef cynw_memory_if< sc_uint<9>, sc_uint<8> >  if_type;
  public:
...
#if !defined(STRATUS_VLG)
template <>
class RAM_500X8::shared_4<CYN::TLM> :
    public sc_module,
    public RAM_500X8::types<CYN::TLM>,
    public cynw_memory_if< sc_uint<9>, sc_uint<8> >
{
  public:
    typedef RAM_500X8::shared_4<CYN::TLM>           this_type;
    typedef sc_uint<9>                  address_type;
    typedef sc_uint<8>                   data_type;
    typedef cynw_memory_if< sc_uint<9>, sc_uint<8> >  if_type;
  public:
