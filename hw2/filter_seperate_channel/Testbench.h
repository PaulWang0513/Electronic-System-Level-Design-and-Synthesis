...
public:
    sc_in_clk i_clk;
    sc_out<bool> o_rst;
    sc_fifo_out<unsigned char> o_r_median;
    sc_fifo_out<unsigned char> o_g_median;
    sc_fifo_out<unsigned char> o_b_median;
    sc_fifo_in<int> i_result_median;
    sc_fifo_out<unsigned char> o_r_mean;
    sc_fifo_out<unsigned char> o_g_mean;
    sc_fifo_out<unsigned char> o_b_mean;
    sc_fifo_in<int> i_result_mean;
