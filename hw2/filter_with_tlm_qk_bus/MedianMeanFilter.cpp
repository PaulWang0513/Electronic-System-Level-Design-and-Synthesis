...
void MedianMeanFilter::blocking_transport(tlm::tlm_generic_payload &payload,
    ...
    case tlm::TLM_READ_COMMAND:
        ...
        case MEDIAN_FILTER_RESULT_ADDR:
            ...
            delay = sc_core::sc_time(10 * CLOCK_PERIOD, sc_core::SC_NS);
            break;
        case MEDIAN_FILTER_CHECK_ADDR:
            buffer.uint = o_result_median.num_available();
            // model the delay of reading data
            delay = sc_core::sc_time(1 * CLOCK_PERIOD, sc_core::SC_NS);
            break;
    ...
    case tlm::TLM_WRITE_COMMAND:
        ...
        delay = sc_core::sc_time(5 * CLOCK_PERIOD, sc_core::SC_NS);
        break;
