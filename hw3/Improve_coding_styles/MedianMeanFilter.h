...
private:
    ...
    void do_mean_filter();
    unsigned char val_median[MASK_X * MASK_Y];    // to store pixels for median filter to find the median value
    unsigned int val_mean;                       // to sum up pixels for mean filter to find the mean value
