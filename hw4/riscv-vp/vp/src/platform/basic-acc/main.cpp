...
public:
	...
	addr_t median_mean_Filter_start_addr = 0x73000000;
 	addr_t median_mean_Filter_size = 0x01000000;
 	addr_t median_mean_Filter_end_addr = median_mean_Filter_start_addr + median_mean_Filter_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > median_mean_Filter_end_addr) &&
